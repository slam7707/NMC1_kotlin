 ...
 * Use the [TabRep.newInstance] factory method to
 * create an instance of this fragment.
 */
class TabRep(val binding: ActivityMainBinding) : Fragment() {
